...
import { CarListUiSchema } from './car-list.ui-schema';
import { CarListDesc } from './car-list.desc';
import jexl from '@app/shared/jexl/get-configured-jexl';

export type CarList = DeepReadonly<
  FromSchema<typeof CarListSchema, { references: references }>
>;
