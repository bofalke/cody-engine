...
import {
  CommandRuntimeInfo,
  makeCommand,
} from '@event-engine/messaging/command';
...
import { UpdateCarUiSchema } from '@app/shared/commands/fleet-management/update-car.ui-schema';
import { UpdateCarDesc } from '@app/shared/commands/fleet-management/update-car.desc';

export type UpdateCar = DeepReadonly<
  FromSchema<typeof UpdateCarSchema, { references: references }>
>;
